...
func RegisterService(r Registration) error {
	...
	if res.StatusCode != http.StatusOK {
		return fmt.Errorf("failed to register service. registry service %v responded with code %v",
...
func ShutdownService(url string) error {
	...
	if res.StatusCode != http.StatusOK {
		return fmt.Errorf("failed to remove service. remove service responded with code %v",
			res.StatusCode)
	}
	return nil
}
